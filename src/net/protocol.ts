...
const GUEST_MESSAGE_TYPES = new Set(['ready', 'move', 'inv', 'invTxn', 'contTxn', 'chunk', 'set', 'break', 'use', 'attack', 'snd', 'interact', 'throw', 'release', 'chat', 'cont', 'craft', 'close', 'respawn', 'sleep', 'xp', 'spawn', 'boatInput', 'dismount', 'ping', 'dimready', 'trade', 'chunkAck', 'schemPaste']);
