...
const MODELS: Record<string, ModelDef> = {
  ...
  rabbit: {
    texW: 64, texH: 32,
    parts: [
      part('head', [0, 16, -1], [box(-2.5, -4, -5, 5, 4, 5, 32, 0), box(-2.5, -9, -1, 2, 5, 1, 52, 0), box(0.5, -9, -1, 2, 5, 1, 58, 0), box(-0.5, -2.5, -5.5, 1, 1, 1, 32, 9)]),
      part('body', [0, 19, 8], [box(-3, -2, -10, 6, 5, 10, 0, 0)], { rot: [-0.35, 0, 0] }),
      part('leg0', [3, 17.5, 3.7], [box(-1, 0, 0, 2, 4, 5, 8, 15)]),
      part('leg1', [-3, 17.5, 3.7], [box(-1, 0, 0, 2, 4, 5, 8, 15)]),
      part('leg2', [3, 17, -1], [box(-1, 0, -1, 2, 7, 2, 0, 15)]),
      part('leg3', [-3, 17, -1], [box(-1, 0, -1, 2, 7, 2, 0, 15)]),
      part('tail', [0, 20, 7], [box(-1.5, -1.5, 0, 3, 3, 2, 52, 6)]),
    ],
  },
  cat: {
    texW: 64, texH: 32,
